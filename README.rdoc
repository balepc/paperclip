...
- icon_stretch.rb         -  streaching small icons to any size
- watermark.rb            -  applying a watermark to image
- white_background.rb     -  used for resizing bigger images to smaller one without loosing image sizes.

Usage:

has_attached_file :asset, :styles =>{:normal      => {:geometry=>'300x300>',:processors => [:icon_stretch, :thumbnail, :watermark, :white_background]}}
